...
class JobDescription extends React.Component<JobDescriptionOuterProps & JobDescriptionInnerProps> {
  public render() {
          ...
          <Container marginTopNavBar>
            <div className="row justify-content-center">
              <div className="col-12 col-lg-8">
                ...
                {paragraphs.concat(commonParagraphs).map((paragraph: JobParagraph, i: number) => (
                  <div key={i} className="row">
                    <div className="col">
                      ...
                      {paragraph.list ? (
                        <ul>
                          {paragraph.list.map((paragraphText: string, textIndex: number) => (
                ...
                <Button className={props.classes.button} variant="raised" color="primary" component="a" href="mailto:codestar@ordina.nl">
                  <Email className={props.classes.leftIcon} />
                  {t('JOBS_CONTACT_BUTTON')}
                </Button>

                <div className="pt-5 pb-3">
                  {t('JOBS_NOTES', { returnObjects: true }).map((note: string, i: number) => (
                    <div key={i}>
                      <small>
                        {'*'.repeat(i + 1)}
                        {note}
