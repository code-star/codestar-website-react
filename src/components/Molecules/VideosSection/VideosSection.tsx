...
export class VideosSection extends React.Component<VideosSectionProps, VideosSectionState> {
  ...
  public render() {
    ...
    return (
      <Section scrollname={scrollname} className={styles.section}>
        <img className={styles.imageFullscreen} src={firstVideoThumbnail} alt="Dynamic thumbnail from most recent Youtube video" />
        <div className="row">
          <div className="col-12">
            <Typography align="center" variant="display4" className={styles.sectionTitle}>
              {t('VIDEOS')}
            </Typography>
        ...
        <div className="row">
          <div className="col-12">
            <div className={styles.carouselWrap}>
              <VideoCarousel cardWidth={300} videos={videos} onSelectVideo={this.onSelectVideo} />
            </div>
          </div>
        </div>
        <VideoDialog video={this.state.selectedVideo} fullScreen={false} onClose={() => this.onSelectVideo(false)} t={t} />
      </Section>
    )
  }
...
export default compose<VideosSectionProps, IPropsOuter>(translate(['events'], { wait: true }))(VideosSection)
