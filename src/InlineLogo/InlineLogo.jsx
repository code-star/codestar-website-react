...
class TextLogo extends Component {
  render() {
    ...
    return (
      <img
        src={`${process.env.PUBLIC_URL}/images/codestar_logo_${dark ? 'dark' : 'light'}.svg`}
        alt="Codestar"
        style={small ? { height: '0.8em', marginBottom: '0.2em' } : { height: '0.8em', marginBottom: '0.12em' }}
      />
    )
  }
}
...
class InlineLogo extends Component {
  replaceWithLogo(text) {
    return text
      .split('Codestar')
      .reduce((accu, t, i) => (i === 0 ? [t] : accu.concat(<TextLogo dark={this.props.dark} small={this.props.small} />, t)), [])
  }
